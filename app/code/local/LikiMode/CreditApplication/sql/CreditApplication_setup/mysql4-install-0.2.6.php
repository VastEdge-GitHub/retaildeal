...
$sql=<<<SQLTEXT
CREATE TABLE `{$this->getTable( 'Liki_CreditApplication_redirect' )}` (
  `CreditApplication_redirect_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  ...
  `CreditApplication_redirect_ip` varchar(50) NOT NULL,
  `CreditApplication_redirect_dtime` datetime NOT NULL,
  PRIMARY KEY (`CreditApplication_redirect_id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

CREATE TABLE `{$this->getTable( 'Liki_CreditApplication_response' )}` (
  `CreditApplication_response_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `merchant_id` varchar(25) NOT NULL,
  `amount` float unsigned NOT NULL,
  `order_id` bigint(20) unsigned NOT NULL,
  ...
  `CreditApplication_response_ip` varchar(50) NOT NULL,
  `CreditApplication_response_dtime` datetime NOT NULL,
  PRIMARY KEY (`CreditApplication_response_id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
SQLTEXT;
